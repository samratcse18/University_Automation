      ...
      <tbody>
        <tr style="width:100%">
          <td style="width:50%;text-align:left">
            <p style="text-transform:uppercase;font-size:0.6rem">Ref: BSMRSTU/{{$letter->dept_name}}/{{$letter->m_name}}/{{$letter_number}}
            </p>
          </td >
            <td style="width:49%;text-align:right"><p style="font-size:0.6rem">তারিখঃ {{date('d-M-Y',strtotime($letter->create_date))}}</p></td>
        </tr>
      </tbody>
    </table>
    ...
    <div class="body-section">
      ...
      <p style="text-align:justify">
        ...
        আগামী   <span id="meeting_time">{{$letter->m_date}}</span> ইং তারিখ {{$letter->m_time}} 
         বঙ্গবন্ধু শেখ মুজিবুর রহমান বিজ্ঞান ও প্রযুক্তি বিশ্ববিদ্যালয়ের {{$letter->m_building_name}} 
      ...
      <div class="signature-box">
        <img
          ...
          alt="dean-signature"
        />
        <span style="font-size:0.6rem;font-style:italic;font-family: 'HelloKetta-d99oX', serif;">{{date('d-m-Y',strtotime($letter->create_date))}}</span>
      </div>
      <p>
