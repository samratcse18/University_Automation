        ...
        <tr>
          <td style="width:43%" class="left-section">
            <div class="left-section">
              <h4 style="font-size:1.1rem;font-weight: 900">চেয়ারম্যান, {{$dept->department_bn}}</h4>
          ...
          <td style="width:47%;" class="right-section">
            <div class="right-section">
              <h4 style="text-align:right;font-size:0.8rem;font-weight: 900;white-space: nowrap;">Chairman, {{$dept->department_full}}</h4>
      ...
      <tbody>
        <tr style="width:100%">
          <td style="width:50%;text-align:left">
            <small
              >সুত্রঃ বশেমুরবিপ্রবি/Office ({{$letter->dept_name}})/Meeting ({{$letter->m_name}})/Meeting
              Number({{$letter_number}})
            </small>
          </td >
            <td style="width:49%;text-align:right"><small>তারিখঃ {{date('d-M-Y',strtotime($letter->create_date))}}</small></td>
        </tr>
      </tbody>
    </table>
    ...
    <div class="body-section">
      ...
      <div class="signature-box">
        <img
          ...
          alt="dean-signature"
        />
        <span>{{date('d-M-Y',strtotime($letter->create_date))}}</span>
      </div>
      <p>
        {{$dept_chairman->name_bangla}}<br />
        চেয়ারম্যান, {{$dept->dept_ban}}
      </p>
      <p>
