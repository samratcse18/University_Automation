...
@section('content')
    ...
    @endif
    <form action="{{ route('student.testmonialPost') }}" method="POST">
        @csrf
        <div class="mt-2 space-y-2 px-[8px] lg:px-0">
            ...
            <div class="flex flex-col justify-start lg:flex-row lg:justify-around lg:w-full">
                ...
                <input type="number" step="any" name="ssc_gpa" id="ssc_gpa" placeholder="Enter student ssc result (gpa)"
                    class="ml-0 lg:w-[60%] lg:ml-[28px] border-2 border-[#006666] px-[2px] focus:outline-none">
            </div>
            <div class="flex flex-col justify-start lg:flex-row lg:justify-around lg:w-full">
                <li class="flex w-full lg:w-[40%] lg:justify-between"><span>HSC Result (GPA)</span><span>:</span>
                </li>
                <input type="number" step="any"name="hsc_gpa" id="hsc_gpa" placeholder="Enter student hsc result (gpa)"
                    class="ml-0 lg:w-[60%] lg:ml-[28px] border-2 border-[#006666] px-[2px] focus:outline-none">
            </div>
            <div class="flex flex-col justify-start lg:flex-row lg:justify-around lg:w-full">
                <li class="relative flex w-full lg:w-[40%] lg:justify-between">
                    <span>Your Degree</span><span>:</span>
                </li>
                <select name="degree_completed" id="degree_completed"
                    class="ml-0 lg:w-[60%] lg:ml-[28px] border-2 border-[#006666] px-[2px] focus:outline-none">
                    <option value="" selected>select status</option>
                    <option value="c1">Completed</option>
                    <option value="c2">Not Completed</option>
                </select>
            </div>
            <div id="addCgpa" class="flex flex-col justify-start lg:flex-row lg:justify-around lg:w-full hidden">
                <li class="flex w-full lg:w-[40%] lg:justify-between"><span>Your Degree (CGPA)</span><span>:</span>
                </li>
                <input type="number" step="any" name="degree_cgpa" id="degree_cgpa" placeholder="Enter your degree (cgpa)"
                    class="ml-0 lg:w-[60%] lg:ml-[28px] border-2 border-[#006666] px-[2px] focus:outline-none">
            </div>
            <div class="flex flex-col justify-start lg:flex-row lg:justify-around lg:w-full">
                <li class="relative flex w-full lg:w-[40%] lg:justify-between">
        ...
        <div class=" shadow sm:rounded-md">
            ...
            <div class="bg-white px-4 py-5 sm:p-6">
                ...
                <div class="grid grid-cols-1">
                    ...
                    <div class=" col-span-2 sm:col-span-3 py-4">

                        <label for="fprogram" class="block text-sm font-medium text-gray-700">F Program</label>

                        <select  name="fprogram" id="fprogram" class="border-2 pl-3  h-10 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-base">
                    ...
                    <div class="flex py-4 flex col-span-2 sm:col-span-3">
                        ...
                        <div class=" col-span-2 sm:col-span-3 w-1/3 px-2">
                    ...
                    <div class=" col-span-2 sm:col-span-3">
                        ...
                        <input type="text" name="vill_area" id="vill_area" value="{{$auth->CurrentAddress}}" placeholder="Enter village/ area name" class="border-2 pl-3 h-10 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-base">
...
@section('scriptDevDept')
    <script>
    $('#degree_completed').on('change',()=>{
        var cgpaVal = $("#degree_completed").val();
        if(cgpaVal == 'c1'){
            $('#addCgpa').removeClass("hidden");
        }else{
            $('#addCgpa').addClass("hidden");
        }
    })
        $('#typeClass').on('change',()=>{
