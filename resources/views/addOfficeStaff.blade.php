...
@section('content')
    ...
    @endif
    <form action="{{ route('admin.officeStaffCreate') }}" method="POST">
        @csrf
        <div class="mt-2 space-y-2 px-[8px] lg:px-0">
            <div class="flex flex-col justify-start lg:flex-row lg:justify-around lg:w-full">
                <li class="flex w-full lg:w-[40%] lg:justify-between"><span>Staff First Name</span><span>:</span></li>
            ...
            <div class="flex flex-col justify-start lg:flex-row lg:justify-around lg:w-full">
                <li class="flex w-full lg:w-[40%] lg:justify-between"><span>Staff Last Name</span><span>:</span></li>
            ...
            <div class="flex flex-col justify-start lg:flex-row lg:justify-around lg:w-full">
                ...
                <input type="text" readonly placeholder="Enter First Name" id="Class" name="Department"
                    value="{{ $dept}}"
                    class="ml-0 lg:w-[60%] lg:ml-[28px] border-2 border-[#006666] px-[2px] focus:outline-none">
            </div>
            <div class="flex flex-col justify-start lg:flex-row lg:justify-around lg:w-full">
