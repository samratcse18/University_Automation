...
<body>
    ...
    <div class="container">
        <div class="left_section">
            ...
            <div class="student_info">
                <ul class="wrapper">
                    ...
                    <li class="row">
                        ...
                        <input type="text" id="class" value="{{ $data->Degree_Level }}, {{$data->Program_Name}}" />
                    </li>
                    <li class="row">
                        <label for="semester">Semester:</label>
                        <input type="text" id="semester" value="{{ $data->Semester }}" />
                    </li>
                    <li class="row">
                    ...
                    <li class="row">
                        ...
                        @foreach ((array)json_decode($data->Current_Session,true) as $item)
                            <span id="session">{{ $item }}</span>
                        @endforeach
                    </li>
                </ul>
            </div>
            <div class="table">
                <table>
                    ...
                    @foreach ($fee as $item)
                        @php
                            if ($item->fee_title == 'Credit Fee') {
                                $total = $total + $totalCreditFee;
                            } else {
                        ...
                        <tr>
                            ...
                            <td>{{ $item->amount }}</td> --}}
                            @if ($item->fee_title == 'Credit Fee')
                                <td>{{ 'Credit Fee' }} <span class="hifen"> - </span></td>
                                <td>{{ $totalCreditFee }}</td>
                            @else
                                <td>{{ $item->fee_title }} <span class="hifen"> - </span></td>
                                <td>{{ $item->amount }}</td>
                            @endif
        ...
        <div class="right_section">
            <h2 id="serial-no">Serial NO: {{ time() }}</h2>
            <p class="part"><small>First Part(Bank Copy)</small></p>
            <div class="header-section">
                <div class="name">
                    Bangabandhu Sheikh Mujibur Rahman Science & Technology university
                    Gopalganj 8100,Bangladesh
