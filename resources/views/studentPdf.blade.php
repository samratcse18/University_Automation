        ...
        <div class="left_section">
            ...
            <div class="header-section">
                ...
                <div class="receipt">
                    ...
                    <div class="barcode">
                        {!! DNS1D::getBarcodeHTML($admission->token, 'C128', 1, 18) !!}
                    </div>
                    <p><small>{{ $admission->token }}</small></p>
                </div>
            </div>
            ...
            <div class="student_info">
                <ul class="wrapper">
                    ...
                    <li class="row">
                        ...
                        <input type="text" id="roll" value="{{ $admission->RollNumber }}" />
                    </li>
                    <li class="row">
                        <label for="session">Session:</label>
                        <input type="text" id="session" value="{{ $admission->Session }}" />
                    </li>
                </ul>
            </div>
            <div class="table">
